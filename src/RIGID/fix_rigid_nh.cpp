...
void FixRigidNH::reset_press(double p_new)
{
...
void *FixRigidNH::extract(const char *str, int &dim)
{
  if (strcmp(str, "body") == 0 || strcmp(str, "masstotal") == 0 || strcmp(str, "t_target") == 0) {
    return FixRigid::extract(str, dim);
  }
  dim=1;
